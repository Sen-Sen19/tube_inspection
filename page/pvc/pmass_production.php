...
<div class="col-6 col-sm-3 ">
                            ...
                            <div id="accounts_table_res" class="table-responsive"
                                ...
                                <table id="mp_pvcdb" class="table table-sm table-head-fixed text-nowrap table-hover">
                                    ...
                                    <tbody id="mp_pvcdb_body" style="text-align: center; padding:20px;">
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #20c997; color: white;">
                <h5 class="modal-title" id="dataModalLabel">Mass Production</h5>
...
<script>
    ...
    function loadTableData(offset, limit, reset = false) {
        ...
        const url = `../../process/pvc_mp_get_data.php?offset=${offset}&limit=${limit}&partName=${partName}&inspectedBy=${inspectedBy}&defectType=${defectType}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
        ...
        fetch(url)
            ...
            .then(data => {
                if (reset) {
                    document.getElementById('mp_pvcdb_body').innerHTML = '';
                }
                populateTable(data);
    ...
    function exportTable() {
        ...
        const filename = `PVC_Mass_Production_${currentDate}.csv`;

        // Construct the URL with search parameters
        const url = `../../process/pvc_mp_export_data.php?partName=${encodeURIComponent(partName)}&inspectedBy=${encodeURIComponent(inspectedBy)}&defectType=${encodeURIComponent(defectType)}&dateFrom=${encodeURIComponent(dateFrom)}&dateTo=${encodeURIComponent(dateTo)}`;
        ...
        <form id="inspectionForm">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <tr>
                    <th>Serial No:</th>
                    <td><input type="text" name="serial_no" value="${rowData.serial_no}" class="form-control"></td>
                    <th>Lot No:</th>
                    <td><input type="text" name="lot_no" value="${rowData.lot_no}" class="form-control" ></td>
                </tr>
                <tr>
                    <th>Appearance Judgement:</th>
                    <td>
    ...
    function saveInspectionDetails() {
        ...
        fetch('../../process/mp_pvc_update.php', {
            method: 'POST',
            body: formData
        })
            .then(response => {
