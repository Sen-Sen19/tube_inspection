<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="pagination.php" class="brand-link">
    ...
    <span class="brand-text font-weight-light">&ensp;TUBE | INSPECTION&ensp; </span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="pagination.php" class="d-block"><?=htmlspecialchars($_SESSION['username']);?></a>
      </div>
    </div>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <a href="pstart_point.php" class="nav-link active">
          <?php } else {?>
          <a href="pstart_point.php" class="nav-link">
          <?php } ?>
...
<li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/web_template/page/user/keyup_search.php") {?>
          <a href="pmass_production.php" class="nav-link active">
          <?php } else {?>
          <a href="pmass_production.php" class="nav-link">
          <?php } ?>
...
<li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/web_template/page/user/keyup_search.php") {?>
          <a href="pend_point.php" class="nav-link active">
          <?php } else {?>
          <a href="pend_point.php" class="nav-link">
          <?php } ?>
