            ...
            <div class="row mb-2">
              <div class="col">
                <button type="submit" class="btn btn-block" name="Login" value="login"
                  style="background-color: #20c997; border-color: #20c997; color: white;">Login</button>
                <a href="Tube-Inspection-System.pdf" target="_blank">
                  <button type="button" class="btn btn-block"
                    style="background-color:rgb(100, 100, 100); border-color:rgb(100, 100, 100); color: white; margin-top:7px;">
                    Work Instruction
                  </button>
                </a>
